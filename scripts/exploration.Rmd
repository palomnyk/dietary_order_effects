...
my_df$super[my_df$super == "Cofactors and Vitamins"] <- "Cof & Vit"
my_df$super[my_df$super == "Xenobiotics"] <- "Xbio"
my_df$super[my_df$super == "Partially Characterized Molecules"] <- "M"
